...
XCVAR_DEF( v_adminEffectDuration,		"5",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_allowForceCombo,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_allowJetpack,				"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_allowJetpackUnlimitedFuel, "1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_allowLedgeGrab,			"1",			CVU_Ledge,			CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_Hook,						"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_HookDelay,					"500",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_hookSpeed,					"9000",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_forcegripUpdaterate,		"300",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_chatProtection,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_voteDelay,					"3000",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_renameTime,				"0.5",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_slapDistance,				"50",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_slaydismember,				"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( v_slideOnHead,				"1",			CVU_HeadSlide,		CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( jp_cinfo,					"0",			NULL,				CVAR_ROM | CVAR_SERVERINFO,						qtrue )
